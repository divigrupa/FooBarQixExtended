...
class ServiceFooBarQixMainTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testFooBar()
    {
        ...
        $this->assertEquals(
            'FooBar',
            $logicObj->serviceFooBarQixMain(352),
            'String \'FooBar\' expected!'
        );
    }
    ...
    public function testFooFooBar()
    {
        ...
        $this->assertEquals(
            'FooFooBar',
            $logicObj->serviceFooBarQixMain(351),
    ...
    public function testFooFooBarQix()
    {
        ...
        $this->assertEquals(
            'FooFooBarQix',
            $logicObj->serviceFooBarQixMain(3057),
    ...
    public function testFooBarBarQix()
    {
        ...
        $this->assertEquals(
            'FooBarBarQix',
            $logicObj->serviceFooBarQixMain(570),
    ...
    public function testFooBarFooBarQix()
    {
        ...
        $this->assertEquals(
            'FooBarFooBarQix',
            $logicObj->serviceFooBarQixMain(13575),
    ...
    public function testFooQixFooBar()
    {
        ...
        $this->assertEquals(
            'FooQixFooBar',
            $logicObj->serviceFooBarQixMain(2352),
    ...
    public function testFooQixFooQix()
    {
        ...
        $this->assertEquals(
            'FooQixFooQix',
            $logicObj->serviceFooBarQixMain(378),
    ...
    public function testBarBarQix()
    {
        ...
        $this->assertEquals(
            'BarBarQix',
            $logicObj->serviceFooBarQixMain(575),
    ...
    public function testBarFooBarQix()
    {
        ...
        $this->assertEquals(
            'BarFooBarQix',
            $logicObj->serviceFooBarQixMain(3575),
    ...
    public function testBarQixBarQix()
    {
        ...
        $this->assertEquals(
            'BarQixBarQix',
            $logicObj->serviceFooBarQixMain(5075),
    ...
    public function testBarQixFooBarQix()
    {
        ...
        $this->assertEquals(
            'BarQixFooBarQix',
            $logicObj->serviceFooBarQixMain(31570),
    ...
    public function testQixFooBar()
    {
        ...
        $this->assertEquals(
            'QixFooBar',
            $logicObj->serviceFooBarQixMain(1351),
    ...
    public function testFooBarQixFooQix()
    {
        ...
        $this->assertEquals(
            'FooBarQixFooQix',
            $logicObj->serviceFooBarQixMain(3780),
    ...
    public function testFooBarQixFooBarQix()
    {
        ...
        $this->assertEquals(
            'FooBarQixFooBarQix',
            $logicObj->serviceFooBarQixMain(3570),
            'String \'FooBarQixFooBarQix\' expected!'
        );
    }
    
    public function testBarQixBarFoo()
    {
        $logicObj =  new Logic();
        
        $this->assertEquals(
            'BarQixBarFoo',
            $logicObj->serviceFooBarQixMain(7535),
            'String \'BarQixBarFoo\' expected!'
        );
    }
