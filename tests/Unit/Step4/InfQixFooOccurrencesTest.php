        ...
        foreach ($this->digits as $digit){
            ...
            $this->assertSame(
                [
                    'success'=>true,
                    'input'=>$input_number,
                    'result'=>join("; ", [             //Expected three output elements in array
                        $digit['output'],
                        $digit['output'],
                        $digit['output']
                    ])
    ...
    public function mixed_digits_test(){
        ...
        $this->assertSame(
            [
                'success'=>true,
                'input'=>$input_number,
                'result'=>join("; ",array_values($outputs_mix))
            ],
        ...
        $this->assertSame(
            [
                'success'=>true,
                'input'=>$input_number,
                'result'=>join("; ",array_values($reverse_outputs_mix))
            ],
            $this->occurrences_service->occurrences($input_number)    //Actual when concatenating each digit into a single number
        );
    }
    ...
    public function mixed_digits_and_no_transformation_test(){
        ...
        $this->assertSame(
            [
                'success'=>true,
                'input'=>$input_number,
                'result'=>join("; ",array_values($expected_output))
            ],
